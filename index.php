...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="seeLicense()'" data-i18n="license">LICENSE-I18N</button>
                <button type="button" class="btn btn-secondary btn-lg" onclick="useProject()'" data-i18n="use-project">USE-PROJECT-I18N</button>
            </div>
    </div>
    </div>
