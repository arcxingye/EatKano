...
<head>
    ...
    <script src="./files/js/createjs.js"></script>
	<script src="./files/js/createjs.min.js"></script>
    <script src="./files/js/jsencrypt.min.js"></script>
	<script src="./files/js/jsencrypt.js"></script>
    <link href="./files/css/bootstrap.css" rel="stylesheet">
	<link href="./files/css/bootstrap.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap.rtl.css" rel="stylesheet">
	<link href="./files/css/bootstrap.rtl.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap-grid.css" rel="stylesheet">
	<link href="./files/css/bootstrap-grid.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap-grid.rtl.css" rel="stylesheet">
	<link href="./files/css/bootstrap-grid.rtl.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap-reboot.css" rel="stylesheet">
	<link href="./files/css/bootstrap-reboot.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap-reboot.rtl.css" rel="stylesheet">
	<link href="./files/css/bootstrap-reboot.rtl.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap-utilities.css" rel="stylesheet">
	<link href="./files/css/bootstrap-utilities.min.css" rel="stylesheet">
	<link href="./files/css/bootstrap-utilities.rtl.css" rel="stylesheet">
	<link href="./files/css/bootstrap-utilities.rtl.min.css" rel="stylesheet">
    <script src="./files/js/bootstrap.bundle.js"></script>
	<script src="./files/js/bootstrap.bundle.min.js"></script>
	<script src="./files/js/bootstrap.esm.js"></script>
	<script src="./files/js/bootstrap.esm.min.js"></script>
	<script src="./files/js/bootstrap.js"></script>
	<script src="./files/js/bootstrap.min.js"></script>
    <script src="./files/js/jquery.min.js"></script>
	<script src="./files/js/jquery.js"></script>
	<script src="./files/js/jquery.slim.js"></script>
