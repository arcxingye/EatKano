...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="aOpenSourceCode('./LICENSE-code')" data-i18n="license-code">LICENSE-CODE-I18N</button>
                <button type="button" class="btn btn-secondary btn-lg" onclick="aOpenSourceCode('./LICENSE-text')" data-i18n="license-text">LICENSE-TEXT-I18N</button>
            ...
            <div class="container">
                ...
                <div id="btn_group" class="container text-nowrap">
                    <div class="d-flex justify-content-center flex-column flex-fill">
                        ...
                        <a class="btn btn-secondary btn-lg" onclick="foreach()" data-i18n="debug">DEBUG-I18N</a>
                    </div>
                </div>
